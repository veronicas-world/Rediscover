...
INSERT INTO conditions (
  ...
  'PMDD',
  'pmdd',
  'Premenstrual Dysphoric Disorder (PMDD) is a severe, cyclic mood and somatic disorder timed to the luteal phase of the menstrual cycle. It is distinct from premenstrual syndrome (PMS) in both severity and neurobiological mechanism. Women with PMDD experience marked affective symptoms — including severe irritability, depression, anxiety, and emotional lability — that appear predictably in the days before menstruation and remit within days of onset. These symptoms are not a manifestation of an underlying psychiatric disorder; they are a paradoxical response of the brain to normal fluctuations in reproductive hormones, particularly allopregnanolone (a neurosteroid metabolite of progesterone). PMDD causes significant occupational, social, and relational impairment and carries elevated risk of suicidality in the luteal phase.',
  'PMDD affects an estimated 3–8% of menstruating women worldwide, or roughly 15–20 million individuals in the United States alone. By DSM-5 criteria, symptoms must be prospectively confirmed across two menstrual cycles. Because of this diagnostic requirement and the persistent stigmatization of menstrual-cycle mood symptoms as "emotional," the condition is chronically underdiagnosed. PMDD was not recognized as a distinct DSM diagnosis until the DSM-5 in 2013, despite being described in the research literature for decades.',
  'Current FDA-approved treatments for PMDD are limited to SSRIs (fluoxetine/Sarafem, sertraline, paroxetine) — used either continuously or in the luteal phase only — and the oral contraceptive Yaz (drospirenone + ethinyl estradiol). GnRH agonists are used off-label to induce chemical menopause, eliminating hormonal cycling entirely; this approach is effective but produces significant bone density loss and hypoestrogenic symptoms, making it unsuitable for long-term use. No approved drug targets the underlying neurosteroid sensitivity mechanism.',
  'PMDD is not caused by abnormal progesterone or allopregnanolone levels per se — serum neurosteroid concentrations are comparable between women with PMDD and healthy controls. The disorder arises from aberrant sensitivity of the GABA-A receptor complex to allopregnanolone (ALLO), a potent positive allosteric modulator of GABA-A. In healthy women, rising luteal-phase ALLO enhances GABA-A inhibitory tone, producing a calming effect. In PMDD, this response is paradoxically anxiogenic and dysphoric, consistent with altered GABA-A subunit composition (likely δ-subunit downregulation in the luteal phase). Serotonin dysregulation is implicated secondarily — serotonin modulates GABA-A activity and allopregnanolone synthesis — explaining the efficacy of SSRIs without full symptom resolution. HPA axis reactivity and inflammatory cytokine dysregulation (elevated IL-6, TNF-α in the luteal phase) are increasingly recognized as contributing mechanisms.',
  'PMDD was classified as a depressive disorder in the appendix of the DSM-IV (1994) and moved to the main text only in 2013 (DSM-5). For roughly two decades, its legitimacy was actively contested by clinicians and researchers who viewed it as a pharmaceutical construct or as medicalization of normal premenstrual experiences. This debate delayed research investment, clinical training, and awareness. NIH funding for PMDD remains a fraction of that allocated to comparably prevalent mood disorders. A 2022 analysis estimated that despite affecting millions, PMDD receives approximately $1–2 million in annual NIH funding — compared to hundreds of millions for major depressive disorder — even though its neurobiological distinctiveness is now well-established.'
);
...
INSERT INTO conditions (
  ...
  'PCOS',
  'pcos',
  'Polycystic Ovary Syndrome (PCOS) is the most common endocrine disorder in women of reproductive age, characterized by a constellation of hormonal and metabolic dysregulation: hyperandrogenism (elevated androgens), ovulatory dysfunction, and polycystic ovarian morphology on ultrasound. It is diagnosed by the Rotterdam criteria (2003), which require two of three features: hyperandrogenism, oligo/anovulation, and polycystic ovaries. PCOS is heterogeneous — no two presentations are identical — ranging from lean phenotypes with isolated menstrual irregularity to obese phenotypes with severe insulin resistance, acanthosis nigricans, and metabolic syndrome. It is the leading cause of anovulatory infertility globally and carries significantly elevated lifetime risk for type 2 diabetes, cardiovascular disease, non-alcoholic fatty liver disease, endometrial cancer, and depression.',
  'PCOS affects an estimated 6–12% of women of reproductive age by conservative diagnostic criteria (NIH 1990), and 15–20% by the broader Rotterdam criteria. This makes it the most prevalent endocrine disorder in women worldwide, affecting between 100–200 million individuals globally. Despite this, it frequently goes undiagnosed for years — particularly in lean phenotypes who lack the stereotyped obese, hirsute presentation — and remains poorly understood by many primary care physicians.',
  'No curative treatment exists. Current management is entirely symptomatic and fragmented across specialties: gynecologists treat menstrual irregularity with oral contraceptives; endocrinologists treat insulin resistance with metformin; dermatologists treat hirsutism with spironolactone; reproductive endocrinologists treat infertility with clomiphene or letrozole. No approved drug addresses the full pathophysiological complex of PCOS. Metformin is used off-label for metabolic and reproductive endpoints and is standard of care in many guidelines despite having no FDA approval specifically for PCOS. Long-term use of oral contraceptives suppresses symptoms without treating underlying hyperandrogenism or insulin resistance, and symptoms recur upon discontinuation.',
  'PCOS is a complex, polygenic metabolic-endocrine disorder with developmental origins potentially beginning in utero. The central hormonal abnormality is elevated LH pulsatility, which drives ovarian androgen overproduction; excess androgens impair follicular maturation, causing anovulation and polycystic morphology. Insulin resistance — present in 50–70% of PCOS patients, including lean phenotypes — exacerbates hyperandrogenism by increasing insulin-stimulated ovarian androgen production and suppressing hepatic SHBG synthesis (which would otherwise bind and inactivate androgens). Chronically elevated LH and insulin together create a self-amplifying loop. Adipose tissue in PCOS also demonstrates dysregulated adipokine secretion (reduced adiponectin, elevated leptin, elevated TNF-α), contributing to systemic inflammation. Gut microbiome dysbiosis has been increasingly implicated as both a cause and consequence of the metabolic dysregulation.',
  'PCOS has been named a syndrome — defined by a symptom cluster — since its original description by Stein and Leventhal in 1935, yet its root cause remains contested and no mechanistic biomarker exists for diagnosis. Research funding relative to disease burden is notably low. A 2018 report by the PCOS Challenge Foundation estimated that PCOS costs the U.S. healthcare system over $4 billion annually in direct and indirect costs, yet NIH funding for PCOS-specific research was approximately $5.8 million in 2019 — a fraction of what similarly prevalent chronic diseases receive. The heterogeneity of the condition has complicated both research design and treatment development, as no single phenotype or biomarker allows clean patient stratification in clinical trials.'
);
...
INSERT INTO conditions (
  ...
  'Adenomyosis',
  'adenomyosis',
  'Adenomyosis is a benign but potentially debilitating uterine condition in which endometrial glands and stroma invade and grow within the myometrium (uterine muscle wall). This invasion disrupts normal myometrial architecture, producing a globally enlarged, "boggy" uterus and — critically — triggering inflammatory, fibrotic, and contractile changes that cause severe dysmenorrhea, heavy menstrual bleeding (HMB), and chronic pelvic pain. Adenomyosis frequently coexists with endometriosis (in 20–50% of cases) and uterine fibroids, complicating both diagnosis and treatment. It is a major driver of iron-deficiency anemia from heavy bleeding and is associated with adverse pregnancy outcomes including miscarriage, preterm birth, and placenta previa.',
  'Adenomyosis is estimated to affect 10–25% of women, with prevalence rising to 40–50% among women with severe dysmenorrhea or abnormal uterine bleeding presenting for surgical evaluation. Population-based estimates are confounded by historically poor non-invasive diagnostic tools — adenomyosis was definitively diagnosed only by histopathological examination of a hysterectomy specimen until transvaginal ultrasound (TVUS) and MRI criteria improved in the 2010s. Prevalence appears highest in women aged 40–50, though it increasingly presents in younger reproductive-age women and adolescents as awareness grows.',
  'Hysterectomy — surgical removal of the uterus — remains the only definitive cure for adenomyosis, an unacceptable option for the large proportion of affected women who are premenopausal, nulliparous, or wish to preserve fertility. Medical management mirrors endometriosis treatment: hormonal suppression with combined oral contraceptives, progestins (dienogest, medroxyprogesterone), the levonorgestrel IUD, and GnRH agonists/antagonists can reduce symptoms but do not eliminate the disease, and symptoms recur upon discontinuation. There is no approved disease-modifying drug that targets adenomyosis pathophysiology. Uterine-preserving surgical options (adenomyomectomy) have high technical difficulty and significant recurrence rates.',
  'Like endometriosis, adenomyosis is an estrogen-dependent, progesterone-resistant inflammatory condition. Endometrial cells invade the myometrium through disruptions in the junctional zone (the innermost myometrial layer at the endometrial-myometrial interface); these invasive lesions express local aromatase (producing estrogen autonomously), demonstrate impaired apoptosis, and secrete pro-inflammatory cytokines that drive fibrosis and hypercontractility of surrounding smooth muscle. Activated macrophages at invasion sites produce MMP-9 (enabling further invasion) and PGE2 (amplifying estrogen biosynthesis and pain signaling). Aberrant uterine contractility — driven by oxytocin receptor upregulation in the diseased myometrium — causes dysmenorrhea through dysfunctional contractions independent of prostaglandin pathways alone. The epigenetic landscape of adenomyotic tissue is markedly altered: DNA hypermethylation of progesterone receptor B promoters and HOXA10 silences normal progestogenic responses, explaining progesterone resistance.',
  'Adenomyosis has been "the forgotten cousin" of endometriosis for most of modern gynecology''s history — a condition mentioned in passing in medical textbooks but rarely the primary subject of clinical research or funding. Because hysterectomy was both the gold standard diagnostic confirmation and the standard treatment, the condition was largely studied retrospectively in surgical specimens rather than in living patients. The absence of a reliable non-invasive diagnostic test until TVUS and MRI criteria were validated in the 2010s further retarded research progress. As of 2024, no drugs are FDA-approved specifically for adenomyosis; all pharmacological management is off-label extrapolation from endometriosis or uterine bleeding research. PMID-indexed adenomyosis-specific clinical trials remain scarce relative to the condition''s prevalence.'
);
