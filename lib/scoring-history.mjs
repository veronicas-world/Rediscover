...
export const SPEC_VERSIONS = {
  "v1.3": {
    label: "v1.3",
    // The public-facing methodology version this rubric shipped under. The
    // site shows only this number; v1.x is internal and never rendered.
    methodology: "v4.2",
    dimensionCount: 5,
    // five 0-2 dimensions
    armStrengthMax: 10,
...
// The methodology version is the only spec version the public site shows.
// It is the number the changelog numbers its entries against.
export const CURRENT_METHODOLOGY_VERSION = CURRENT_SPEC.methodology;
export const PREVIOUS_METHODOLOGY_VERSION = PREVIOUS_SPEC.methodology;
