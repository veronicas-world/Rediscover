...
const CARDS: CarouselCard[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Denominator awareness",    desc: "FAERS and community data are signal-generating, not causal; signals from these sources require corroboration before elevation above Emerging" },
    ],
  },
  {
